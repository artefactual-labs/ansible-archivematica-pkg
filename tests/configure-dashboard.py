...
class PyConfigureDashboard(unittest.TestCase):
    def setUp(self):
        ...
        self.am_username = os.getenv('AM_USERNAME','test')
        self.am_first_name = os.getenv('AM_FIRST_NAME','test')
        self.am_last_name = os.getenv('AM_LAST_NAME','test')
        self.am_email = os.getenv('AM_EMAIL','test@example.com')
        self.am_password = os.getenv('AM_PASSWORD','test')
        self.am_orgname = os.getenv('AM_ORGNAME','Organization name')
        self.am_orgid = os.getenv('AM_ORGID','Organization ID')
    ...
    def test_py_configure_dashboard(self):
        ...
        driver.find_element_by_id("id_org_name").send_keys(self.am_orgname)
        driver.find_element_by_id("id_org_identifier").clear()
        driver.find_element_by_id("id_org_identifier").send_keys(self.am_orgid)
        driver.find_element_by_id("id_username").clear()
        driver.find_element_by_id("id_username").send_keys(self.am_username)
        driver.find_element_by_id("id_first_name").clear()
        driver.find_element_by_id("id_first_name").send_keys(self.am_first_name)
        driver.find_element_by_id("id_last_name").clear()
        driver.find_element_by_id("id_last_name").send_keys(self.am_last_name)
        driver.find_element_by_id("id_email").clear()
        driver.find_element_by_id("id_email").send_keys(self.am_email)
        driver.find_element_by_id("id_password1").clear()
        driver.find_element_by_id("id_password1").send_keys(self.am_password)
        driver.find_element_by_id("id_password2").clear()
        driver.find_element_by_id("id_password2").send_keys(self.am_password)
